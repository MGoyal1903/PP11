...
var rainData = [{ name: "Roorkee",  rainfall: [5, 6, 5, 5, 4, 7, 8] }, 
                { name: "Pauri",    rainfall: [3, 3, 3, 1, 2, 2, 2] },];
...
rainDance(rainData);
 ...
 function rainDance(rainData)
 {
    ...
    let display = [];
     ...
     {
        avgRainfall = rainData[i].rainfall;
        cityname = rainData[i].name;
        ...
        {
             totalSum = totalSum + avgRainfall[i];
        }

    
        let numsCnt = avgRainfall.length;
        ...
        display.push(cityrainavg);
        console.log(cityrainavg);
